...
const HeroSection = () => {
    ...
    return <div className="flex flex-col items-start justify-center gap-4 px-6 md:px-16 lg:px-36 
    ...
    bg-cover bg-center h-screen">
        ...
        <div className="flex items-center gap-4 text-gray-300">
            ...
            <div className="flex items-center gap-1">
                <CalendarIcon className="size-4.5"/> 2h 8m
            </div>
        </div>

        
        <p className='max-w-md text-gray-300'>
            In a post-apocalyptic world where cities 
            ride on wheels and consume each other to survive, 
