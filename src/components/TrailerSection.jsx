...
const TrailerSection = () => {
    ...
    useEffect(() => {
        console.log(typeof currentTrailer.videoUrl);
    }, [])

    return <div className='px-6 md:px-16 1g:px-24 x1:px-44 py-20 overflow-hidden'> 
        ...
        <div className="group grid grid-cols-4 gap-4
        md:gap-8 mt-8
        max-w-3xl mx-auto">
            ...
            onClick={()=> setCurrentTrailer(trailer)}>| I
                <img src={trailer.image} alt="trailer" className="rounded-lg w-full h-full object-cover brightness-75"/>
                <PlayCircleIcon strokeWidth={1.6} className="absolute top-1/2 left-1/2 w-5 md:2-8 h-5 md:h-12 transform -translate-1/2"/>
            </div>)}
