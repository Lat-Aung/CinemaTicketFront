...
const DateSelect = ({dateTime, id}) => {
    ...
    const onBookHandler = () => {
        ...
        nav(`/movies/${id}/${selected}`)
        scrollTo(0,0)
        
    }

    return <div id="dataSelect" className="pt-30">
        <div className='flex flex-col md:flex-row items-center justify-between gap-10 relative p-8 bg-primary/10 border border-primary/20 rounded-1g'>
